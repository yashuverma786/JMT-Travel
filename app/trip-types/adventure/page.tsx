...
import { Mountain, MapPin, Calendar, Users, Star, Search, Filter, Zap } from "lucide-react"
...
export default function AdventureTripsPage() {
  ...
  const fetchAdventureTrips = async () => {
    try {
      const response = await fetch("/api/trips?tripType=Adventure")
      if (response.ok) {
        const data = await response.json()
        setTrips(data.trips || [])
      }
    } catch (error) {
      console.error("Error fetching adventure trips:", error)
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold">Adventure Packages</h1>
          </div>
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              ...
              <Input
                placeholder="Search adventure destinations..."
                value={searchTerm}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">{sortedTrips.length} Adventure Packages Found</h2>
        </div>
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">No adventure packages found</h3>
            ...
            {sortedTrips.map((trip) => {
              ...
              return (
                <Card key={trip._id} className="overflow-hidden hover:shadow-lg transition-shadow group">
                  <div className="relative">
                    <Image
                      src={trip.featuredImage || "/placeholder.svg?height=200&width=300&query=adventure+destination"}
                      alt={trip.title}
                      width={300}
                      height={200}
                    ...
                    <div className="absolute top-2 left-2 flex gap-2">
                      ...
                      {trip.difficulty && (
                        <Badge className={`${getDifficultyColor(trip.difficulty)} text-white`}>{trip.difficulty}</Badge>
                      )}
                    </div>
