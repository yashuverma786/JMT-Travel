...
import { Star, Clock, MapPin, Search, Filter, Sparkles } from "lucide-react"
...
export default function TrendingTripsPage() {
  ...
  const filteredTrips = trendingTrips
    .filter(
      (trip) =>
        ...
        <div className="container px-4 sm:px-6">
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Trending Now</h1>
            </div>
            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              Explore the hottest destinations and experiences that are trending right now among travelers
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 sm:px-6">
            ...
            {filteredTrips.map((trip) => (
              ...
              >
                <div className="relative">
                  ...
                  <Badge className="absolute top-2 right-2 bg-purple-500 text-white">{trip.category}</Badge>
                  <Badge className="absolute bottom-2 left-2 bg-pink-500 text-white flex items-center gap-1">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t">
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="text-2xl font-bold text-purple-600">₹{trip.price.toLocaleString()}</span>
          ...
          {filteredTrips.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No trending trips found matching your criteria.</p>
            </div>
          )}
        </div>
      </section>
