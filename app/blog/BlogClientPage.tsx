...
const allBlogPosts = [
  ...
  },
  {
    ...
    excerpt: "A guide to the best beaches in Goa, from lively shores to serene coves.",
    content: "Full blog content here...",
    image: "/placeholder.svg?height=400&width=600",
    author: "Rahul Desai",
  ...
  },
  {
    ...
    excerpt: "Discover the rich biodiversity of India's national parks and wildlife sanctuaries.",
    content: "Full blog content here...",
    image: "/placeholder.svg?height=400&width=600",
    author: "Anjali Rao",
...
const POSTS_PER_PAGE = 6 // Number of posts to show per load
      ...
      <div className="container py-8 sm:py-12 px-4 sm:px-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6 sm:mb-8 justify-center">
          {categories.map((category) => (
            <Button
              ...
              aria-pressed={category === "All"} // Example for active state
            >
              {category}
            </Button>
          ))}
        ...
        <section aria-labelledby="latest-articles">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {nonFeaturedPosts.slice(0, visiblePosts).map((post) => (
              <article key={post.id}>
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group h-full">
        ...
        {/* Load More Button */}
        {visiblePosts < nonFeaturedPosts.length && (
